...
<svelte:head>
  <title>Blog | HireHive France</title>
  <meta
    name="description"
    content="Nous avons toujours été très fiers de pouvoir collaborer avec Indeed, l’un des premiers job boards au monde, depuis de nombreuses années. Indeed ont d’ailleurs été l’un de nos premiers partenaires et nous a permis d’atteindre un large vivier de talents au niveau mondial. Aujourd’hui, nous sommes ravis d’annoncer que nous sommes le premier logicielRead More" />
</svelte:head>
  ...
  <div class="bg-navy py-16">
    <div class="max-w-5xl mx-auto lg:flex lg:items-center lg:justify-between px-4">
      <h2 class="text-1xl font-bold tracking-tight text-white sm:text-3xl font-rozanonva">
        <span class="text-yellow-400"> Réservez votre démo </span> <br /> dès aujourd'hui et commencez à trouver et à embaucher
