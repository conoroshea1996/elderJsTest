...
exports.hookEntityDefinitions = void 0;
...
const hookEntityDefinitions = {
    ...
    htmlAttributesStack: 'A "stack" of attributes to be merged together that are written to the <html> tag.By default, it containt "{lang: "en"}" or an other lang set in your elder.config.js',
    bodyAttributesStack: 'A "stack" of attributes to be merged together that are written to the <body> tag.',
    headStack: 'A "stack" of strings to be merged together (along with cssStack) that are written to the <head> tag. If you are looking to customize the head you\'re probably better looking at the "headString."',
    ...
    cssString: 'The the css string that is wrapped in the styleTag. Added purely for convenience in case users wanted to minify the css.',
    ...
    request: 'An object that represents the parameters required to generate a specific page on a specific route. This object originating from the all() query of a route.js file.',
    ...
    layoutHtml: "The compiled HTML response for a route containing all of the HTML from the Route's layout and template. ",
...
exports.hookEntityDefinitions = hookEntityDefinitions;
